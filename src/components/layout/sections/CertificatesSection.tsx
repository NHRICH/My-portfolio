...
const certificates = [
  {
    ...
    issuer: 'Coursera',
    date: 'March 2023',
    image: '/Certicifate/Coursera SV6M08W8NPTK_page-0001.jpg',
  ...
  },
  {
    ...
    issuer: 'Udemy',
    date: 'July 2023',
    image: '/Certicifate/UC-d9c120e2-606f-456c-8ef1-23ac4.jpg',
  ...
  },
  {
    ...
    issuer: 'Udemy',
    date: 'October 2023',
    image: '/Certicifate/UC-a7b05843-f3ac-49c1-9655-e1f76.jpg',
  ...
  },
  {
    ...
    issuer: 'Coursera',
    date: 'January 2024',
    image: '/Certicifate/Coursera P24OOUD3GKMY (2).jpg',
  ...
  return (
    <section id="certificates" className="section bg-secondary relative overflow-hidden">
      <div className="container mx-auto z-10">
        ...
        <div className="certificates-carousel relative mx-auto max-w-4xl">
            ...
            {certificates.map((cert, index) => (
              <motion.div
                ...
                animate={{ 
                  ...
                  z: index === activeCertificate ? 10 : 0
                }}
              ...
              >
                <div className="bg-secondary-light border border-primary bg-opacity-30 backdrop-blur-lg rounded-lg overflow-hidden shadow-2xl h-full flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 relative">
                    {isImageLoading && index === activeCertificate && (
          ...
          <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full flex justify-between px-4 z-20">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={() => setActiveCertificate(prev => (prev === 0 ? certificates.length - 1 : prev - 1))}
            >
              &lt;
            </motion.button>
            <motion.button
              ...
              whileHover={{ scale: 1.1, backgroundColor: 'rgba(255, 215, 0, 0.3)' }}
              whileTap={{ scale: 0.9 }}
              onClick={() => setActiveCertificate(prev => (prev === certificates.length - 1 ? 0 : prev + 1))}
            >
              &gt;
            </motion.button>
          </div>
